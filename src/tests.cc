...
// ----------------------------------------------------------------------------
{
    ...
    step("Addition")
        ...
        .test(CLEAR, "-1.23 TANH -2.34", ID_add).expect("-3.18257 93256 58929 54289 07208 91501 65092");
    step("Subtraction")
        ...
        .test(CLEAR, "-1.23 TANH -2.34", ID_subtract).expect("1.49742 06743 41070 45710 92791 08498 34908");
    step("Multiplication")
        ...
        .test(CLEAR, "-1.23 TANH -2.34", ID_multiply).expect("1.97163 56220 41895 13036 42868 86113 86316");
    step("Division")
        ...
        .test(CLEAR, "-1.23 TANH -2.34", ID_divide).expect("0.36007 66348 96978 43713 27867 05769 93629 1");
    step("Power")
        .test(CLEAR, "1.23 2.34", ID_pow).expect("1.62322 21516 85370 76170 21776 74374 041")
        .test(CLEAR, "1.23 -2.34", ID_pow).expect("0.61605 86207 88111 35803 50956 46724 9859")
        ...
        .test(CLEAR, "-1.23 23", ID_pow).expect("-116.90082 15014 43291 74653 48578 88750 679")
        .test(CLEAR, "-1.23 -2.34", ID_pow).error("Argument outside domain")
        .test(CLEAR, "1.234 SIN 2.34", ID_pow).expect("0.00012 57743 10956 55759 81666 83961 25288 14")
        .test(CLEAR, "1.23 COS -2.34", ID_pow).expect("1.00053 93880 00606 36152 22273 75863 578")
...
#define TFN(name)  TFNA(name, 0.321)
    ...
    TFN(sinh).expect("0.32654 11649 51806 35701 22065 63885 7342");
    TFN(cosh).expect("1.05196 44159 41947 53843 52241 43605 6778");
    TFN(tanh).expect("0.31041 08466 05886 02148 50502 09383 09580 5");
    TFN(asinh).expect("0.31572 82658 29379 61791 08945 47102 0639");
    TFNA(acosh, 1.321).expect("0.78123 02051 96252 61474 22171 61603 4349");
    TFN(atanh).expect("0.33276 15884 81814 59580 17641 70508 75105");
    TFN(log1p).expect("0.27838 90255 40188 26677 16283 42111 551");
    TFN(lnp1).expect("0.27838 90255 40188 26677 16283 42111 551");
    TFN(expm1).expect("0.37850 55808 93753 89544 74307 07491 4123");
    TFN(log).expect("-1.13631 41558 52121 18735 43303 10107 29");
    TFN(log10).expect("-0.49349 49675 95127 92187 04308 57283 44913");
    TFN(exp).expect("1.37850 55808 93753 89544 74307 07491 412");
    TFN(exp10).expect("2.09411 24558 50892 67051 98819 85846 254");
    TFN(exp2).expect("1.24919 61256 53376 70052 14667 82085 807");
    TFN(erf).expect("0.35014 42208 20023 82355 16032 45050 23913");
    TFN(erfc).expect("0.64985 57791 79976 17644 83967 54949 76087");
    TFN(tgamma).expect("2.78663 45408 45446 21139 00136 19645 449");
    TFN(lgamma).expect("1.02483 46099 57303 81225 72539 42202 042");
    TFN(gamma).expect("2.78663 45408 45446 21139 00136 19645 449");
...
#undef TFNA
    ...
    step("pow")
        ...
        .expect("4.19760 13402 69557 03133 41557 04388 71")
        .test(CLEAR, "1.23 2.31", ID_pow)
        .expect("1.61317 24907 55543 84434 14148 92337 986");
    ...
    step("ln for very small value")
        ...
        .expect("-230.25850 92994 04568 40179 91454 68436 4");
...
// ----------------------------------------------------------------------------
{
    ...
    step("Power")
        ...
        .test(CLEAR, "1.23 COS -2.34", ID_pow).expect("12.99302 28339 82056 39426 87501 27880 37045 92536 16587 57403 56215 08880 50350 81194 61226 34205 49843 15463 66527 28429 54768 38033 10733 34")
...
#define TFN(name)               TFNA(name, 0.321)
    ...
    TFN(tanh).expect("0.31041 08466 05886 02148 50502 09383 09588 97683 04936 20954 99090 64143 22194 05034 27301 10326 36239 07947 98201 74192 58627 58374 14428 5903");
...
#undef TFNA
    ...
    step("pow")
        .test(CLEAR, "3.21 1.23 pow", ENTER)
        .expect("4.19760 13402 69557 03133 41557 04388 71185 62403 13482 15741 54975 76397 39514 93831 64438 34447 96787 36431 56648 68643 95471 93476 15863 237")
        .test(CLEAR, "1.23 2.31", ID_pow)
