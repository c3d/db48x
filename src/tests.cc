...
// ----------------------------------------------------------------------------
{
    ...
    step("Power")
        .test(CLEAR, "1.23 2.34", ID_pow).expect("1.62322 21516 85370 76170 21776 74374 04111")
        .test(CLEAR, "1.23 -2.34", ID_pow).expect("0.61605 86207 88111 35803 50956 46724 98589")
        ...
        .test(CLEAR, "-1.23 23", ID_pow).expect("-116.90082 15014 43291 74653 48578 88750 679")
        .test(CLEAR, "-1.23 -2.34", ID_pow).error("Argument outside domain")
        .test(CLEAR, "1.234 SIN 2.34", ID_pow).expect("0.00012 57743 10956 55759 81666 83961 25288 1382")
...
#define TFN(name)  TFNA(name, 0.321)
    ...
    TFN(exp10).expect("2.09411 24558 50892 67051 98819 85846 25406");
    ...
    TFN(tgamma).expect("2.78663 45408 45472 36795 07642 13322 339");
    TFN(lgamma).expect("1.02483 46099 57313 19869 10927 54028 872");
    TFN(gamma).expect("2.78663 45408 45472 36795 07642 13322 339");
...
#undef TFNA
    ...
    step("pow")
        ...
        .expect("4.19760 13402 69557 03133 41557 04388 7099")
        .test(CLEAR, "1.23 2.31", ID_pow)
        .expect("1.61317 24907 55543 84434 14148 92337 98566");
...
// ----------------------------------------------------------------------------
{
    ...
    step("Power")
        ...
        .test(CLEAR, "-1.23 23", ID_pow).expect("-116.90082 15014 43291 74653 48578 88750 68007 69541 15726 7")
        .test(CLEAR, "-1.23 -2.34", ID_pow).error("Argument outside domain")
        .test(CLEAR, "1.234 SIN 2.34", ID_pow).expect("0.87345 13971 11436 95155 06870 44540 70174 27291 82925 84673 60872 62775 48945 10990 94126 48813 44383 61846 88450 45997 75145 12827 34289 0581")
        .test(CLEAR, "1.23 COS -2.34", ID_pow).expect("12.99302 28339 82056 39426 87501 27880 37045 92536 16587 57403 56215 08880 50350 81194 61226 34205 49843 15463 66527 28429 54768 38033 10733 31")
...
#define TFN(name)               TFNA(name, 0.321)
    ...
    TFN(exp2).expect("1.24919 61256 53376 70052 14667 82085 80659 83711 96789 11078 50872 03968 89639 54927 57400 23696 00219 70718 47302 80643 90803 89872 28867 484");
    ...
    TFN(tgamma).expect("2.78663 45408 45472 36795 07642 12781 77275 03497 82995 16602 55760 07828 51424 44941 90542 89306 12905 33223 77665 62682 21806 18456 46874 199", 2000);
    TFN(lgamma).expect("1.02483 46099 57313 19869 10927 53834 88666 18028 66769 43209 08437 87004 46327 04911 25770 09539 00530 12325 23947 42519 39269 66085 30959 32", 2000);
    TFN(gamma).expect("2.78663 45408 45472 36795 07642 12781 77275 03497 82995 16602 55760 07828 51424 44941 90542 89306 12905 33223 77665 62682 21806 18456 46874 199", 2000);
