...
'Dedicace' Attach
Libs
@ Expecting { Dedicace SiDensity TTest1 TTest1Args TTest2 TTest2Args TTestW TTestWArgs TTestP TTestPArgs TTestLR Chi2GOF Chi2Indep Chi2Var Chi2VarArgs FTestVar FTestVarArgs Anova1 FTestLR }
```
...
Libs
@ Expecting { SiDensity TTest1 TTest1Args TTest2 TTest2Args TTestW TTestWArgs TTestP TTestPArgs TTestLR Chi2GOF Chi2Indep Chi2Var Chi2VarArgs FTestVar FTestVarArgs Anova1 FTestLR }
```
